...
import com.guru.muhwezidenisliam.course_gudie.activity_classes.News;
...
import com.guru.muhwezidenisliam.course_gudie.utils.DateTimeUtils;
import com.guru.muhwezidenisliam.course_gudie.utils.VectorDrawableUtils;
...
public class TimeLineAdapter extends RecyclerView.Adapter<TimeLineViewHolder> {
    ...
    public void onBindViewHolder(TimeLineViewHolder holder, final int position) {
        ...
        holder.text_title.setText(timeLineModel.getText_title());
        holder.news_time_line.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent news_intent = new Intent(mContext,News.class);
