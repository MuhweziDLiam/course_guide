package com.guru.muhwezidenisliam.course_gudie.model;
...
public class TimeLineModel implements Parcelable {
    ...
    public TimeLineModel(String text_title,String mMessage, String mDate, OrderStatus mStatus) {
    ...
    public void setText_title(String title){ this.text_title = title; }
